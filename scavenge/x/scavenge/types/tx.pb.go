...
type MsgCommitSolution struct {
	Creator          string `protobuf:"bytes,1,opt,name=creator,proto3" json:"creator,omitempty"`
	SolutionHash     string `protobuf:"bytes,2,opt,name=solutionHash,proto3" json:"solutionHash,omitempty"`
	SolutionScavenge string `protobuf:"bytes,3,opt,name=solutionScavenge,proto3" json:"solutionScavenge,omitempty"`
}
...
func (m *MsgCommitSolution) GetSolutionScavenge() string {
	if m != nil {
		return m.SolutionScavenge
	}
	return ""
}
...
var fileDescriptor_6b36a47d3ea84630 = []byte{
	...
	,
}
...
func (m *MsgCommitSolution) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.SolutionScavenge) > 0 {
		i -= len(m.SolutionScavenge)
		copy(dAtA[i:], m.SolutionScavenge)
		i = encodeVarintTx(dAtA, i, uint64(len(m.SolutionScavenge)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.SolutionHash) > 0 {
...
func (m *MsgCommitSolution) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SolutionScavenge", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SolutionScavenge = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTx(dAtA[iNdEx:])
